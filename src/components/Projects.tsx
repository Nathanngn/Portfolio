...
export default function Projects() {
  ...
  return (
    <Section id="projects" className="bg-gradient-to-b from-gray-50 to-white">
      <Container>
        <SectionTitle 
          title="Mes Projets" 
        ...
        {projects.length > initialProjectCount && (
          <div className="flex flex-col items-center gap-8">
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
            >
              <div className="absolute inset-0 bg-blue-500/20 rounded-full blur-lg group-hover:bg-blue-500/30 transition-colors" />
              <div className="relative bg-gradient-to-br from-blue-500 to-blue-600 rounded-full p-4 shadow-lg group-hover:shadow-blue-500/25 transition-all">
                <ChevronDown 
            ...
            <a
              ...
              className="group relative inline-flex items-center gap-3 bg-gradient-to-r from-blue-600 to-indigo-600 
