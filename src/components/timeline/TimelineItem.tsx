...
export default function TimelineItem({ year, title, subtitle, logo, isLast = false, index }: TimelineItemProps) {
  return (
    <motion.div 
    ...
    >
      ...
      <div className="w-full grid grid-cols-2 gap-8 items-center">
        ...
        <div className="flex justify-end items-center gap-4">
          <div className="bg-white rounded-2xl p-6 shadow-lg transform transition-all duration-300 hover:scale-105 hover:shadow-xl w-[500px] h-[180px]">
